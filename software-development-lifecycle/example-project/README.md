...
1. Open the artifact you need to create for your project
2. Open the corresponding Power Atlas example side-by-side
3. Follow the same structure, replacing Power Atlas details with your project's details
4. Use the linked runbook for step-by-step procedure
5. Check against the linked standard for compliance
